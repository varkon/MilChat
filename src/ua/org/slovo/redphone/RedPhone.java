...
import ua.org.slovo.redphone.ui.CallControls;
import ua.org.slovo.redphone.ui.CallScreen;
...
public class RedPhone extends Activity {
  ...
  private void handleAnswerCall() {
    ...
    if (event != null) {
      callScreen.setActiveCall(event.getRecipient(), getString(ua.org.slovo.securesms.R.string.RedPhone_answering));
  ...
  private void handleDenyCall() {
    ...
    if (event != null) {
      ...
      callScreen.setActiveCall(event.getRecipient(), getString(ua.org.slovo.securesms.R.string.RedPhone_ending_call));
      delayedFinish();
    }
  }
  ...
  private void handleOutgoingCall(@NonNull RedPhoneEvent event) {
    callScreen.setActiveCall(event.getRecipient(), getString(ua.org.slovo.securesms.R.string.RedPhone_dialing));
  }
