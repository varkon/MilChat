...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://ua.org.slovo.provider.securesms.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("ua.org.slovo.provider.securesms.mms", "mms/#", SINGLE_ROW);
  }
