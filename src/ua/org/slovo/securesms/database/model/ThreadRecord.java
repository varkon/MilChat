 ...
 */
package ua.org.slovo.securesms.database.model;
...
import ua.org.slovo.securesms.database.MmsSmsColumns;
...
public class ThreadRecord extends DisplayRecord {
  ...
  public SpannableString getDisplayBody() {
    if (SmsDatabase.Types.isDecryptInProgressType(type)) {
      ...
      return emphasisAdded(context.getString(ua.org.slovo.securesms.R.string.ThreadRecord_called));
    } else if (SmsDatabase.Types.isIncomingCall(type)) {
      return emphasisAdded(context.getString(ua.org.slovo.securesms.R.string.ThreadRecord_called_you));
    } else if (SmsDatabase.Types.isMissedCall(type)) {
      return emphasisAdded(context.getString(ua.org.slovo.securesms.R.string.ThreadRecord_missed_call));
