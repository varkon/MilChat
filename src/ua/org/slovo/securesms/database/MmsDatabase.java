...
import ua.org.slovo.securesms.database.documents.IdentityKeyMismatch;
import ua.org.slovo.securesms.database.documents.IdentityKeyMismatchList;
import ua.org.slovo.securesms.database.documents.NetworkFailure;
import ua.org.slovo.securesms.database.documents.NetworkFailureList;
import ua.org.slovo.securesms.database.model.DisplayRecord;
import ua.org.slovo.securesms.database.model.MediaMmsMessageRecord;
import ua.org.slovo.securesms.database.model.MessageRecord;
import ua.org.slovo.securesms.database.model.NotificationMmsMessageRecord;
import ua.org.slovo.securesms.jobs.TrimThreadJob;
...
import ua.org.slovo.securesms.util.JsonUtils;
...
import static ua.org.slovo.securesms.util.Util.canonicalizeNumber;
import static ua.org.slovo.securesms.util.Util.canonicalizeNumberOrGroup;
...
public class MmsDatabase extends MessagingDatabase {
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (ua.org.slovo.securesms.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).setUnread(threadId);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = ua.org.slovo.securesms.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = ua.org.slovo.securesms.util.Util.toIsoBytes(transactionId);
