...
import ua.org.slovo.securesms.crypto.SessionUtil;
...
import ua.org.slovo.securesms.sms.IncomingJoinedMessage;
...
public class DirectoryHelper {
  ...
  private static Optional<Account> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("ua.org.slovo.securesms");
  ...
  private static Optional<Account> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "ua.org.slovo.securesms");
